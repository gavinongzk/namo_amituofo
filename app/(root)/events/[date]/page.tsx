...
import { getEventByDate, getEventById, getRelatedEventsByCategory } from '@/lib/actions/event.actions';
...
export async function generateMetadata({ params }: { params: { date: string } }): Promise<Metadata> {
  const event = await getEventByDate(params.date);
...
export default async function EventDetails({ params: { date }, searchParams }: EventDetailsProps) {
  // Try to get event by date
