...
export default function PrivacyPolicy() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <h1 className="text-3xl font-bold mb-8">隐私政策 <span className="text-gray-500">|</span> Privacy Policy</h1>
      
      <div className="space-y-8">
        <section>
          <h2 className="text-2xl font-semibold mb-4">1. 引言 <span className="text-gray-500">|</span> Introduction</h2>
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-4">2. 我们收集的个人数据 <span className="text-gray-500">|</span> Personal Data We Collect</h2>
          <div className="space-y-4">
            <p>我们可能收集以下类型的个人数据：</p>
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-4">3. 我们如何收集个人数据 <span className="text-gray-500">|</span> How We Collect Personal Data</h2>
          <div className="space-y-4">
            <p>我们通过以下方式收集个人数据：</p>
            <ul className="list-disc pl-6">
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-4">4. 收集、使用和披露的目的 <span className="text-gray-500">|</span> Purpose of Collection, Use and Disclosure</h2>
          <div className="space-y-4">
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-4">5. 同意 <span className="text-gray-500">|</span> Consent</h2>
          <div className="space-y-4">
            <p>
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-4">6. 个人数据的保护 <span className="text-gray-500">|</span> Protection of Personal Data</h2>
          <div className="space-y-4">
            <p>
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-4">7. 个人数据的保留 <span className="text-gray-500">|</span> Retention of Personal Data</h2>
          <div className="space-y-4">
            <p>
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-4">8. 个人数据向新加坡境外的转移 <span className="text-gray-500">|</span> Transfer of Personal Data Outside Singapore</h2>
          <div className="space-y-4">
            <p>
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-4">9. 您的权利 <span className="text-gray-500">|</span> Your Rights</h2>
          <div className="space-y-4">
            <p>根据PDPA，您有权：</p>
            <ul className="list-disc pl-6">
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-4">10. Cookies和类似技术 <span className="text-gray-500">|</span> Cookies and Similar Technologies</h2>
          <div className="space-y-4">
            <p>
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-4">11. 数据保护官 <span className="text-gray-500">|</span> Data Protection Officer</h2>
          <div className="space-y-4">
            <p>
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-4">12. 隐私政策更新 <span className="text-gray-500">|</span> Updates to Privacy Policy</h2>
          <div className="space-y-4">
            <p>
        ...
        <section>
          <div className="text-sm text-gray-600 mt-8">
            <p className="mb-2">最后更新日期：2025年4月29日</p>
