    ...
    <div className="bg-white shadow-lg rounded-lg overflow-hidden">
      ...
      <div className="p-6 space-y-4">
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            <p className="text-sm text-grey-600">Location 地点</p>
            <p className="font-semibold">{event.location}</p>
          </div>
          <div>
            <p className="text-sm text-grey-600">Category 类别</p>
        ...
        <div className="border-t pt-4 mt-4">
          <div className="grid grid-cols-4 gap-4">
            <div className="relative">
              <p className="text-sm text-grey-600">Max Seats 最大座位数</p>
            ...
            <div>
              <p className="text-sm text-grey-600">Total Registrations 总报名数</p>
              <p className="font-semibold">{totalRegistrations}</p>
            </div>
            <div>
              <p className="text-sm text-grey-600">Attended Users 已出席用户</p>
              <p className="font-semibold">{attendedUsersCount}</p>
            </div>
            <div>
              <p className="text-sm text-grey-600">Cannot Recite & Walk 不能绕佛</p>
              <p className="font-semibold">{cannotReciteAndWalkCount}</p>
            </div>
            <div>
              <p className="text-sm text-grey-600">Cancelled Users 已取消用户</p>
