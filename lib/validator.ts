...
export const eventFormSchema = z.object({
  ...
  description: z.string().min(3, '描述至少需要3个字符 / Description must be at least 3 characters').max(20000, '描述必须少于20000个字符 / Description must be less than 20000 characters'),
  ...
  showRefugeQuestion: z.boolean().optional()
})
